...
# update index (67000qps)
time sysbench /usr/share/sysbench/oltp_read_only.lua --mysql-db=sb_test --db-driver=mysql --mysql-host=mysql --mysql-user=root --mysql-password=password --time=60 --table_size=100000 --db-ps-mode=disable --threads=8 --point_selects=0 --range_selects=0 --index_updates=1 --non_index_updates=0 --delete_inserts=0 run

# update no-index (65000qps)
time sysbench /usr/share/sysbench/oltp_read_only.lua --mysql-db=sb_test --db-driver=mysql --mysql-host=mysql --mysql-user=root --mysql-password=password --time=60 --table_size=100000 --db-ps-mode=disable --threads=8 --point_selects=0 --range_selects=0 --index_updates=0 --non_index_updates=1 --delete_inserts=0 run

# delete insert (3275qps)
time sysbench /usr/share/sysbench/oltp_read_only.lua --mysql-db=sb_test --db-driver=mysql --mysql-host=mysql --mysql-user=root --mysql-password=password --time=60 --table_size=100000 --db-ps-mode=disable --threads=8 --index_updates=0 --non_index_updates=0 --delete_inserts=1 run
